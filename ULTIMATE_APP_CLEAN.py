        ...
        if word_groups:
            ...
            for j, word_group in enumerate(word_groups):
                ...
                drawtext = (
                    ...
                    f"shadowcolor=black@0.8:shadowx={shadow_offset}:shadowy={shadow_offset}:"
...
def create_modern_video_effects(width, height, platform="TikTok"):
    ...
    if platform == "TikTok":
        effects.extend([
            "eq=contrast=1.15:brightness=0.05:saturation=1.25:gamma=0.95",
            "curves=red='0/0 0.5/0.58 1/1':green='0/0 0.5/0.52 1/1':blue='0/0 0.5/0.48 1/1'"
        ])
